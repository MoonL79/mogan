...
bool   mupdf_normal_image_size (url image, int& w, int& h, string* wcm= nullptr,
                                string* hcm= nullptr);
bool   mupdf_pdf_image_size (url image, int& w, int& h, string* wcm= nullptr,
                             string* hcm= nullptr);
void   mupdf_pretty_image_size (url image, string& w, string& h);
string mupdf_load_and_parse_image (const char* path, int& w, int& h,
                                   string extension, string* wcm= nullptr,
                                   string* hcm= nullptr);
